      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Our comprehensive suite of premium services ensures your academic
            journey exceeds expectations at every milestone.
          </p>
        </div>
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-purple-600 via-purple-500 to-purple-400 rounded-3xl p-12 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <h3 className="text-3xl font-playfair font-bold mb-4 text-yellow-400">
              Ready to Begin Your Premium Education Journey?
            </h3>
            <p className="text-yellow-300 mb-8 text-lg">
              Schedule a complimentary consultation with our senior education
              consultants and discover personalized pathways to your academic
              success.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                onClick={() => scrollToSection("contact")}
                className="bg-gradient-to-r from-yellow-500 via-yellow-400 to-yellow-300 text-black hover:opacity-90 px-8 py-4 text-lg font-semibold luxury-shadow"
              >
              ...
              <Button
                variant="outline"
                className="border-yellow-400 text-yellow-400 hover:bg-yellow-100 px-8 py-4 text-lg font-semibold backdrop-blur-sm"
              >
