...
const universityData = {
  harvard: {
    ...
    flag: "🇺🇸",
    image:
      "https://images.unsplash.com/photo-1562774053-701939374585?q=80&w=2069&auto=format&fit=crop",
    description:
  ...
  stanford: {
    ...
    description:
      "Stanford University is a private research university in Stanford, California. Known for academic excellence and proximity to Silicon Valley.",
  ...
  mit: {
    ...
    flag: "🇺🇸",
    image:
      "https://images.unsplash.com/photo-1564981797816-1043664bf78d?q=80&w=2074&auto=format&fit=crop",
    description:
      "MIT is a private research university in Cambridge, Massachusetts, known for its innovation in science and technology.",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Badge
                variant="outline"
                className="border-white text-white text-lg px-4 py-2"
              >
              ...
              <CardContent className="p-8">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {university.topCourses.map((course, index) => (
                    <div
                      key={index}
                      className="flex items-center p-4 bg-gold/10 rounded-lg border border-gold/20"
                    >
                ...
                <div className="space-y-2">
                  {university.specialties.map((specialty, index) => (
                    <Badge
                      key={index}
                      variant="outline"
                      className="w-full justify-start p-2 border-navy/20 text-navy"
                    >
                      {specialty}
                    </Badge>
                  ))}
