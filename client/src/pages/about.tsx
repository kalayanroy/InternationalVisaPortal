...
const teamMembers = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1494790108755-2616b612b6c5?w=300&h=300&fit=crop&crop=face&auto=format",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&h=300&fit=crop&crop=face&auto=format",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=300&h=300&fit=crop&crop=face&auto=format",
...
const values = [
  {
    ...
    title: "Excellence",
    description:
      "We strive for the highest standards in everything we do, ensuring exceptional outcomes for our students.",
  },
  {
    icon: Heart,
    title: "Student-Centric",
    description:
      "Every decision we make is guided by what's best for our students' academic and personal growth.",
  },
  {
    icon: Shield,
    title: "Integrity",
    description:
      "We maintain the highest ethical standards and transparency in all our interactions and processes.",
  },
  {
    icon: Lightbulb,
    title: "Innovation",
    description:
      "We continuously evolve our services to provide cutting-edge solutions for modern education challenges.",
  },
];
...
const milestones = [
  {
    ...
    description:
      "Started with a vision to make international education accessible to all students",
  },
  {
    year: "2012",
    title: "1,000 Students Milestone",
    description:
      "Successfully placed our 1,000th student in a top international university",
  },
  {
    year: "2016",
  ...
  },
  {
    ...
    description:
      "Launched comprehensive online consultation and application tracking platform",
  },
  {
    year: "2024",
    title: "10,000+ Success Stories",
    description:
      "Reached milestone of 10,000+ students successfully placed with 98% visa approval rate",
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
      ...
      <div className="relative pt-24 pb-16">
        ...
        <div
          ...
          style={{
            backgroundImage: `url('https://img.freepik.com/premium-photo/university-admission-web-banner_1281315-2204.jpg')`,
          }}
        ></div>
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            ...
            education dreams through expert guidance and unwavering support
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-slate-700 mb-6">
                To bridge the gap between ambitious students and world-class
                educational opportunities by providing comprehensive,
                personalized guidance through every step of the international
                education journey.
              </p>
              <p className="text-slate-600">
                We believe that quality education should be accessible to every
                deserving student, regardless of their background or
                geographical location. Our mission is to make this vision a
                reality through expert guidance, innovative solutions, and
            ...
            <div className="bg-gradient-to-br from-navy/10 to-gold/10 p-8 rounded-2xl">
              ...
              <p className="text-slate-700">
                To be the world's most trusted partner in international
                education, known for our exceptional success rates, personalized
                approach, and transformative impact on students' lives and
                careers.
              </p>
            </div>
          </div>
                ...
                >
                  ...
                  >
                    <Card className="hover:shadow-lg transition-shadow duration-300">
                      <CardContent className="p-6">
                        <div className="font-bold text-gold text-lg mb-2">
                          {milestone.year}
                        </div>
