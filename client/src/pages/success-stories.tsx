...
const successStories = [
  {
    ...
    year: "2023",
    image: "https://images.unsplash.com/photo-1494790108755-2616b612b6c5?w=400&h=400&fit=crop&crop=face&auto=format",
    story: "Coming from a middle-class family, I never thought I could afford Stanford. StudyBridge not only helped me with the application process but also secured a 75% scholarship. Their visa guidance was exceptional, and I got approved on my first attempt.",
  ...
  },
  {
    ...
    story: "The application process for Oxford seemed impossible until I found StudyBridge. They helped me craft a compelling research proposal and connected me with potential supervisors. The visa interview preparation was thorough and gave me confidence.",
  ...
  },
  {
    ...
    story: "As a first-generation college student, navigating international applications was overwhelming. StudyBridge's counselors became my mentors, guiding me through every step from university selection to securing housing in Toronto.",
  ...
  },
  {
    ...
    story: "After three rejections from other consultants, StudyBridge took a different approach. They identified gaps in my profile and helped me strengthen my application. The result? Acceptance to my dream program with a scholarship.",
  ...
  },
  {
    ...
    story: "StudyBridge helped me secure admission to Harvard with a full scholarship. Their comprehensive support included GMAT preparation, essay writing, and interview coaching. The visa process was seamless with their expert guidance.",
  ...
  },
  {
    ...
    story: "With a background in engineering, transitioning to finance seemed challenging. StudyBridge helped me build a compelling narrative for my career change and prepared me thoroughly for Cambridge's rigorous interview process.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
      ...
      <div className="relative pt-24 pb-16 bg-gradient-to-r from-navy to-navy/90">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            Real students, real dreams achieved. Discover how we've helped thousands of students reach their international education goals
          </p>
        </div>
      </div>
      ...
      <div className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-navy mb-4">Student Success Stories</h2>
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              From first-generation college students to career changers, read how we've helped students from diverse backgrounds achieve their dreams
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {successStories.map((story) => (
              <Card key={story.id} className="group overflow-hidden hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-white to-slate-50">
                    ...
                    <div className="flex-1 p-6">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-navy mb-1">{story.name}</h3>
                          <p className="text-slate-600 text-sm mb-1">{story.age} years old</p>
                      ...
                      <div className="mb-4 p-3 bg-navy/5 rounded-lg">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="font-semibold text-navy">{story.university}</span>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                        <div>
                          ...
                          <div className="font-semibold text-navy">{story.beforeGPA}</div>
                        </div>
                        <div>
                          <span className="text-slate-600">Test Scores:</span>
                          <div className="font-semibold text-navy text-xs">{story.testScores}</div>
                        </div>
                      </div>

                      {/* Current Role */}
                      <div className="mb-4">
                        <span className="text-slate-600 text-sm">Current Role:</span>
                        <div className="font-semibold text-navy">{story.currentRole}</div>
                      </div>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-navy mb-4">Video Testimonials</h2>
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              ...
              <Card key={index} className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <div className="relative h-48 bg-gradient-to-br from-navy/20 to-gold/20 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-slate-600 text-sm">Video Testimonial {index}</p>
                  </div>
                </div>
                <CardContent className="p-4">
                  <h3 className="font-semibold text-navy mb-2">Student Success Story {index}</h3>
                  <p className="text-sm text-slate-600">Watch how our guidance helped achieve remarkable results</p>
                </CardContent>
              </Card>
            ))}
          </div>
